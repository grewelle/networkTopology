...
function yp = schisto_eq(t, y, a,b, m, gamma, theta, thetap, nu, muC, muM, Q, piC, piM, V, H, N, n)
...
% y(:,1) = W; y(:,2) = Y; y(:,3) = C; y(:,4) = M
    ...
    yp_matrix(:,4) = (piM./V).* thetap.* [(1-m).*H.*(y(:,1)/2) + Q'*(m.*H.*y(:,1)/2)] - muM*y(:,4); %ADDED a TRANSPOSE IN FRONT OF Q _ MAY BE WRONG
