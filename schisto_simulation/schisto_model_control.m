...
function [y_shaped, t, R0s] = schisto_model_control( n, N, H, loc, spaths, A, m, isNetwork, W0, thetaReduction, redIndices)
    ...
    %control
%     thetap(1) = thetap(1) - 0.1;
%     thetap(4) = thetap(4) - 0.1;
    thetap(redIndices) = thetap(redIndices) - thetaReduction;
